...
export function ResultsModal({
  ...
  return (
    <div className="scrim">
      <div className="card">
        <div className="verdict" style={{ color: vcol }}>
          {vtxt}
        </div>
        <h2>
        ...
        <div className="sect manifest">
          ...
          <div className="derived">
            <div>
              <span>Ore income</span>
              <b style={{ color: "var(--ok)" }}>+{you.revenue.toFixed(0)}</b>
            </div>
          </div>
          ...
          <div className="manifest-net">
            <span>Net</span>
            <b style={{ color: netUp ? "var(--ok)" : "var(--danger)" }}>
              {netUp ? "+" : ""}
              {you.net.toFixed(0)}
            </b>
          </div>
        ...
        <button className="go" onClick={onAgain} autoFocus>
          Refit &amp; run again
        </button>
      </div>
    </div>
