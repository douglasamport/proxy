...
import { applyToggleDump } from "@/lib/refine-engine";

// POST {} -> { state, err } — toggles the cooler dump on/off. Turning it on
// costs action charge; turning it off is free (see applyToggleDump()'s
